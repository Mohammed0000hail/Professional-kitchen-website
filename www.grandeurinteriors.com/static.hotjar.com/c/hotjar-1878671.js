window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "cs_project_id": null,
    "account_id": 1199013,
    "account_signature": "b06db69adf8b6966820bf4300c934b9f345f1144596216e17ed9a13a22b8f023"
};
...
! function() {
    ...
    var o, s = function() {
        ...
        u = function(e, t, n) {
            var r;
            l.loggedMetrics[e] = a(a({}, l.loggedMetrics[e]), {}, ((r = {})[t] = n || {}, r))
        },
        d = function(e) {
            if (!e) return "value";
        ...
        f = function(e, t) {
            ...
            return "lab" === e && (n = c.browser.inLab), "field" === e && (n = l.isFieldMetricsEnabled), t ? n && t.flush : n
        },
        h = function(e) {
            var t = !1,
            ...
            start: function() {
                try {
                    ...
                    return l.genericTags = {
                        site_id: r
                    }, l.isDebugEnabled = Math.random() <= u.universalDebug || a.has("client_script.metrics.debug") && Math.random() <= u.debug, l.isMetricsEnabled = Math.random() <= u.metrics, l.isFieldMetricsEnabled = l.isMetricsEnabled && Math.random() <= u.fieldMetrics, o = new i(h, c.buffer.bufferSize, c.buffer.flushInterval), e
                } catch (e) {
            ...
            count: function(e, t) {
                ...
                try {
                    var c, u = d(r),
                        h = l.loggedMetrics[e],
                        p = 0;
                    if (n ? (p = (h && h[u] || 0) + (n.value || 1), l.loggedMetrics[e] = a(a({}, h), {}, ((c = {})[u] = null != n && n.flush ? 0 : p, c))) : p = 1, f(s, n)) {
                        var m = {
                            name: e,
                            type: "count",
                            value: p,
    ...
    var S, T, E, R, M, O, x, C, A, I, N, k = hj.metrics.start(),
        U = !(!window.CS_CONF || null === (j = window.CS_CONF.voc) || void 0 === j || !j.enabled),
        P = !(window.CS_CONF || !(null !== (_ = window.hjSiteSettings.features) && void 0 !== _ && _.includes("cs_lite") || window._hjSettings.csid));
    if (window.hjLazyModules = window.hjLazyModules || {
        ...
        }, U) window._uxa.push(["start:hotjar", window.hjSiteSettings]), window.hj.scriptLoaded = !0;
    else if (P) {
        var B = (O = (S = window.hjSiteSettings).suppress_all || S.suppress_text || (null === (T = S.suppress_all_on_specific_pages) || void 0 === T ? void 0 : T.length), x = function(e) {
                var t, n, r, i, a, o = {
                ...
                return o
            }(S), C = x.anonymisationMethod, A = x.replayRecordingMaskedUrlRegex, I = x.replayRecordingMaskedUrlRegexRules, {
                CS_CONF_BASE: {
                    ...
                    implementations: (M = S, m(v, (N = M.state_change_listen_mode, "manual" === N ? [] : [{
                        template: {
            ...
            D = B.CS_CONF_BASE,
            L = B.PII_SELECTORS;
        window.CS_CONF_BASE = D, window._uxa = window._uxa || [], L && window._uxa.push(["setPIISelectors", {
            PIISelectors: L
        }]);
        var F = window._hjSettings.environment,
            z = "t.contentsquare.net";
        F && "live" !== F && (window._hjSettings.csid && (window.CS_CONF_BASE.projectId = window._hjSettings.csid), z = "t-staging.contentsquare.net");
        var H = document.createElement("script");
        H.type = "text/javascript", H.async = !0, H.src = "//".concat(z, "/uxa/smb/tag.js"), document.getElementsByTagName("head")[0].appendChild(H)
        ...
        d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", u.appendChild(d), c.revision = "5ff46c9", window.hjBootstrap = c
    }, window.hjBootstrap("https://script.hotjar.com/", "modules.60031afbf51fb3e88a5b.js", "1878671"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: k,
